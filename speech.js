...
function busca(){
	db.query("select id from transacoes where coletado=0 limit 10", function (err, tx, fields) {
			
		if(tx.length){
			console.log('coletando '+tx[0]['id']);

			//tx[0]['id']='e78d239a1b97a3602cfce1fd6d4e5603fc633bee9c62180adf4fb067251fa6d3';
